...
def get_args():
    ...
    parser.add_argument(
        "--mode", type=str, default="all", choices=["all", "train", "test"]
    )
...
class MyNet(pl.LightningModule):
    ...
    def _shared_log(self, stage=None, outputs=None, prog: bool = False):
        ...
        self.log(f"{stage}_accuracy", accuracy, prog_bar=prog, sync_dist=True)
        return
    ...
    def training_step(self, batch, batch_idx):
        ...
        self.log(
            "train_accuracy", acc.mean(), on_epoch=True, on_step=True, sync_dist=True
        )
...
if __name__ == "__main__":
    ...
    if args.mode == "all" or args.mode == "test":
        ...
        vis.vis_dataset(
            ...
            classes=classes,
            save_path="./results/cifar10_sample_images.png",
            mean=mean,
            std=std,
            skip=skip,
        )
        ...
        vis.vis_dataset(
            ...
            model=model,
            classes=classes,
            save_path="./results/cifar10_predict_images.png",
            mean=mean,
            std=std,
            skip=skip,
            to_wandb=to_wandb,
